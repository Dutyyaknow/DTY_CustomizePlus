...
public class ActorAssignmentUi
{
    ...
    private void SetupCombos()
    {
        ...
        _mountCombo = new Penumbra.GameData.Gui.NpcCombo(new StringU8("##mountCombo"), _actorManager.Data.Mounts);
        _companionCombo = new Penumbra.GameData.Gui.NpcCombo(new StringU8("##companionCombo"), _actorManager.Data.Companions);
        _bnpcCombo = new Penumbra.GameData.Gui.NpcCombo(new StringU8("##bnpcCombo"), _actorManager.Data.BNpcs);
        _enpcCombo = new Penumbra.GameData.Gui.NpcCombo(new StringU8("##enpcCombo"), _actorManager.Data.ENpcs);
        _ornamentCombo = new Penumbra.GameData.Gui.NpcCombo(new StringU8("##ornamentCombo"), _actorManager.Data.Ornaments);
        _ready = true;
    }
